...
const ChatContainer = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full w-full sm:max-w-[700px] mx-auto bg-white absolute top-0 left-0 sm:relative">
      <div >
        <ChatHeader />
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-16">
        {messages.map((message) => (
          <div
            key={message._id}
            className={`chat ${
              //if logged in user sends message align to right side
